...
ingredients = input(
    "List of ingredients that you have already at home (for example, chicken, potatoes, and carrots: "
)
...
also group the list of ingredients so that is easy to get at the supermaket: """
